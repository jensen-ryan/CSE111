...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    #Compute and return the total molar mass of all theelements listed in symbol_quantity_list.
    #Each element insymbol_quantity_list is a list in the form: ["symbol", quantity].
    total_mass = 0
    ...
    for element in symbol_quantity_list:
        ...
        total_mass += round(periodic_table_dict[symbol][1] * quantity , 5)
...
def main():
    ...
    total_mass = compute_molar_mass(symbol_quantity_list, periodic_table)
    #Compute the number of moles of the sample.
    total_moles = massg / total_mass
    #Print the molar mass.
    print(f'{total_mass} grams/mole')
    #Print the number of moles.
    print(f'{round(total_moles, 5)} moles')
